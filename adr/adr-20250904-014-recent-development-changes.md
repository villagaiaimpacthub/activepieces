# ADR-20250904-014: Recent Development Changes
...
Commits:
02ba45e098 feat: complete category e final system integration and production readiness
5149ae3c25 docs(adr): auto-generate ADR for recent changes
...
adr/adr-20250904-013-recent-development-changes.md
database-setup-verification.md
deploy-sop.sh
docker-compose.sop.yml
docs/README.md
docs/admin-guide/installation.md
docs/api-reference/README.md
docs/developer-guide/custom-pieces.md
docs/user-guide/creating-sops.md
...
packages/server/api/src/app/ee/database/migrations/postgres/1744780900000-AddSopSystemTables.ts
packages/server/api/src/app/ee/database/migrations/postgres/1744781000000-SeedSopTemplates.ts
...
tests/e2e/activepieces-integration.test.ts
tests/e2e/database-schema.test.ts
tests/e2e/export-system.test.ts
tests/e2e/sop-core.test.ts
tests/e2e/sop-workflows.test.ts
tests/e2e/ui-automation.test.ts
